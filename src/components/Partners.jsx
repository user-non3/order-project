...
export default function Partners() {
  return (
    <section
      id="partners"
      className="w-[1909px] h-[1920px] bg-white font-raleway container mx-auto"
    >
      <div className="bg-[url('../assets/post_one.png')] bg-cover h-[500px] rounded-[20px] text-white flex flex-col items-start justify-center container mx-auto">
        <p className="w-[1035px] h-[150px] text-[64px] font-bold pl-[120px]">
          Achieving business goals with SMS Synergy Inc.
        </p>
      </div>
      <div className="text-color-about container mx-auto mt-[80px]">
        <p>Partners</p>
        <h1 className="text-main-blue text-[40px] font-bold mt-[30px]">
          <span className="opacity-30">Our</span> Partners
        </h1>
        <p className="text-color-about w-[617px] h-[112px] mt-[30px] text-2xl">
        ...
        {/* GRID TEMPLATE */}
        <div class="grid grid-rows-2 grid-flow-col mt-[40px] gap-[24px] mb-[300px]">
          <div class="row-span-8 w-[617px] h-[890px] rounded-[20px] bg-[url('../assets/poster_two.png')] flex flex-col justify-between p-[30px]">
          ...
          <div class="col-span-4 w-[699px] h-[205px] bg-grid-color  rounded-[20px] p-[24px]">
            <img
              src={partnerOne}
              className="mb-[24px] w-[200px] h-[56px] rounded-2xl"
            />
            <h1 className="text-main-blue text-[24px] font-bold">
