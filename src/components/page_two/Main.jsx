...
export default function Main() {
  return (
    <div className="bg-[url('../assets/bg_about.png')] w-full bg-cover pt-5">
      <div className="container mx-auto w-[1440px] h-[600px] ">
        <Navbar />
        <section className="mt-[110px] font-raleway flex flex-col justify-center items-center" id="main">
